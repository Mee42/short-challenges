...
fun main() {
    ...
    while(true) {
        ...
        if(pieceCount.values.contains(0)) {
            ...
            println("dev.mee42.emccue.freeze.Team $winner is the winner!")
            break
        }
    }
}
...
fun play(board: Board, currentPlayer: Team) {
    print("Turn: $currentPlayer. Current dev.mee42.emccue.freeze.Board:\n$board\ndev.mee42.emccue.freeze.Point to use? ")
